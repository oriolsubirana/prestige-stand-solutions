...
import 'react';
import { B as Button } from '../chunks/button_BMEarwLR.mjs';
/* empty css                                   */
...
const ContactInfo = () => {
  return /* @__PURE__ */ jsxs("div", { className: "col-span-1 bg-primary-300 rounded-[30px] px-8 py-[76px] flex flex-col gap-[30px] w-full", children: [
    /* @__PURE__ */ jsxs("h5", { className: "flex flex-col xl:flex-row gap-4 items-center text-l font-jost tracking-tight", children: [
      " ",
      /* @__PURE__ */ jsx(Mail, {}),
...
const ContactForm = () => {
  return /* @__PURE__ */ jsx("div", { className: "col-span-1 lg:col-span-2", children: /* @__PURE__ */ jsxs("form", { className: "w-full grid grid-cols-2 gap-x-10 gap-y-[50px]", children: [
    ...
    /* @__PURE__ */ jsx("label", { htmlFor: "company", children: /* @__PURE__ */ jsx(
      "input",
      {
        type: "text",
        name: "company",
    ...
    /* @__PURE__ */ jsx("label", { htmlFor: "exhibition", children: /* @__PURE__ */ jsx(
      "input",
      {
        type: "text",
        name: "exhibition",
    ...
    /* @__PURE__ */ jsx("label", { htmlFor: "size", children: /* @__PURE__ */ jsx(
      "input",
      {
        type: "number",
        name: "size",
...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Prestige Stand Solutions Contact Us", "data-astro-cid-uw5kdbxl": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="w-full h-[20vh] flex justify-center items-end" data-astro-cid-uw5kdbxl> <div class="py-[30px] lg:py-[41px] px-[60px] lg:px-[30px] flex flex-col justify-center items-center bg-white gap-2.5" data-astro-cid-uw5kdbxl> <h1 class="text-[30px] leading-[40px] lg:text-[50px] lg:leading-[62px] font-dm capitalize text-primary-200" data-astro-cid-uw5kdbxl>
Contact Us
</h1> <p class="text-base lg:text-[22px] lg:leading-[33px] tracking-tight font-jost text-text-gray" data-astro-cid-uw5kdbxl> <a href="/" data-astro-cid-uw5kdbxl>Home</a> / Contact
</p> </div> </section>  <section class="lg:max-w-[1200px] flex flex-col gap-8 lg:gap-10 px-12 xl:px-0 w-full mx-auto pt-[100px] lg:pt-[20px] pb-12" data-astro-cid-uw5kdbxl> <!-- main section --> <div class="grid grid-cols-1 gap-[55px] pt-10 lg:grid-cols-3 place-content-center" data-astro-cid-uw5kdbxl> ${renderComponent($$result2, "ContactInfo", ContactInfo, { "data-astro-cid-uw5kdbxl": true })} ${renderComponent($$result2, "ContactForm", ContactForm, { "data-astro-cid-uw5kdbxl": true })} </div> </section> <div class="border border-gray-300" data-astro-cid-uw5kdbxl></div> ` })} `;
}, "/Users/oriolsubiranaperdiguer/workspace/prestige-stand-solutions/src/pages/contact.astro", void 0);

const $$file = "/Users/oriolsubiranaperdiguer/workspace/prestige-stand-solutions/src/pages/contact.astro";
const $$url = "/contact";
